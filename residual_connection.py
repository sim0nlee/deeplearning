...
def train(dataloader, model, loss_fn, optimizer, epoch):
    ...
    for i, (X, y) in enumerate(dataloader):
        ...
        if i % 100 == 0:
            ...
            writer.add_scalar("Global Beta", model.beta, epoch*n + i)
            writer.add_scalar("weight_grad_norms", weight_grad_norms, epoch*n + i)
            writer.add_scalar("bias_grad_norms", bias_grad_norms, epoch*n + i)
            print()
